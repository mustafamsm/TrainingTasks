            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @if (Route::has('login.show'))
                    <a href="{{ route('login.show') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">{{ __('site.login') }}</a>
                @endif
                @if (Route::has('register.show'))
                    <a href="{{ route('register.show') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">{{ __('site.register') }}</a>
                @endif

                @else
                
                <a href="{{ route('dashboard.index') }}"
                    class="text-sm text-gray-700 dark:text-gray-500 underline">{{ __('site.home') }}</a>
                 @endguest
        </div>
